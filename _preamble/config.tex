...
\newcommand{\DocPresentation}[1]{\def\docpresentation{#1}}
...
\newcommand{\DocDedication}[1]{\def\docdedication{#1}}
\newcommand{\DocAcknowledgments}[1]{\def\docacknowledgments{#1}}
\newcommand{\DocEpigraph}[2]{\def\docepigraph{#1}\def\epigraphauthor{#2}}
\newcommand{\SetStartingPage}[1]{\def\docstartingpage{#1}}
\newcommand{\BoardNames}[1]{\def\boardnames{#1}}
...
\newcommand{\BuildTemplateSetup}{%
    ...
    %> 3. Configura o hyperref e o bibtex
    \iftoggle{ufvnorms}{%
        \hypersetup{
            colorlinks=true, 
            allcolors=black
